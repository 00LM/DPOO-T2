...
public class SandboxConjuntos
{
    ...
    {
        List<String> nuevaL = getCadenasComoLista();
        Collections.reverse(nuevaL);
        return nuevaL;
    }
    ...
    public String getUltima( )
    {
    	...
    	String primer = nuevaL.get(arbolCadenas.size()-1);
    	return primer;
    }
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
    	...
    	for (Object hijoObjeto : objetos) {
    		nuevoConjunto.add(hijoObjeto.toString());
		}
    ...
    {
    	TreeSet<String> nuevoConjunto = new TreeSet<String>();
    	for (String element : arbolCadenas) {
    		nuevoConjunto.add(element.toUpperCase());	
		}
    ...
    public TreeSet<String> invertirCadenas( )
    {
    	...
    	TreeSet<String> nuevoC = new TreeSet<String>(comparador);
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
    	for(String element : otroArreglo)
	    	if (!arbolCadenas.contains(element)) {
	    		return false;
	    	}
    	return true;
